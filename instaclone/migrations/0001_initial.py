    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='instaclone.image')),
                ('userr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='instaclone.profile')),
            ],
        ),
    ]
